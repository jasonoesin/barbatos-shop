...
<div class="w-full h-full flex flex-col justify-center items-center bg-gray-300 py-10 box-content pb-20">
        <div class="text-center bg-gray-200 w-[30rem] px-4 py-2 text-gray-800">Register</div>
        <form method="post" action="{{url('/register')}}" class="justify-center flex flex-col w-[30rem] max-h-[1rem]] bg-gray-100 p-4 drop-shadow-lg">
            @csrf
